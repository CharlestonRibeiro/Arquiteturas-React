...
- **tests:** alterações em arquivos de teste, seguindo as convenções descritas em [Testes](/basic/tests.md).
## Commits
...
|:-:|:-:|:-:|
|**build**|mudanças que afetam o processo de build do projeto ou dependências externas|Vite, adicionar/remover dependências do npm|
...
|**ci**|mudanças nos arquivos de configuração de CI|GitHub Actions, Vercel, etc|
